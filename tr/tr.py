...
class TranslationConstants(QObject):
    ...
    STRUCTURE_NAME = QT_TR_NOOP("Structure name")
    ADD_MEMBER = QT_TR_NOOP("Add Member")
    EDIT_MEMBER = QT_TR_NOOP("Edit Member")
    REMOVE_MEMBER = QT_TR_NOOP("Remove Member")
    MOVE_UP = QT_TR_NOOP("Move Up")
    MOVE_DOWN = QT_TR_NOOP("Move Down")
    MEMBER_NAME = QT_TR_NOOP("Member name")
    MEMBER_OFFSET = QT_TR_NOOP("Member offset")

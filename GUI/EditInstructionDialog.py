...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.lineEdit_OpCodes = QtWidgets.QLineEdit(Dialog)
        self.lineEdit_OpCodes.setObjectName("lineEdit_OpCodes")
        self.gridLayout.addWidget(self.lineEdit_OpCodes, 1, 0, 1, 1)
        ...
        self.lineEdit_Instruction = QtWidgets.QLineEdit(Dialog)
        self.lineEdit_Instruction.setEnabled(False)
        self.lineEdit_Instruction.setReadOnly(True)

...
class Ui_MainWindow_MemoryView(object):
    def setupUi(self, MainWindow_MemoryView):
        ...
        self.scrollAreaWidgetContents_Registers.setGeometry(QtCore.QRect(0, 0, 336, 457))
        ...
        self.scrollAreaWidgetContents_2.setGeometry(QtCore.QRect(0, 0, 510, 176))
    ...
    def retranslateUi(self, MainWindow_MemoryView):
        ...
        item.setText(_translate("MainWindow_MemoryView", "Int Repr"))
        item = self.tableWidget_Stack.horizontalHeaderItem(3)
        item.setText(_translate("MainWindow_MemoryView", "Float Repr"))

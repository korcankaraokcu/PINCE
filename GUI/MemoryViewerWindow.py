...
class Ui_MainWindow_MemoryView(object):
    def setupUi(self, MainWindow_MemoryView):
        ...
        self.scrollAreaWidgetContents_Registers.setGeometry(QtCore.QRect(0, 0, 336, 342))
        ...
        self.scrollAreaWidgetContents_2.setGeometry(QtCore.QRect(0, 0, 545, 200))
        ...
        self.tableView_HexView_Hex.setTextElideMode(QtCore.Qt.TextElideMode.ElideNone)
        ...
        self.tableView_HexView_Ascii.setTextElideMode(QtCore.Qt.TextElideMode.ElideNone)
        ...
        self.actionBookmarks = QtGui.QAction(MainWindow_MemoryView)
        self.actionBookmarks.setObjectName("actionBookmarks")
        self.actionStackTrace_Info = QtGui.QAction(MainWindow_MemoryView)
        self.actionStackTrace_Info.setObjectName("actionStackTrace_Info")
        self.actionInject_so_file = QtGui.QAction(MainWindow_MemoryView)
        self.actionInject_so_file.setObjectName("actionInject_so_file")
        self.actionRun = QtGui.QAction(MainWindow_MemoryView)
        self.actionRun.setObjectName("actionRun")
        self.actionBreak = QtGui.QAction(MainWindow_MemoryView)
        self.actionBreak.setObjectName("actionBreak")
        self.actionStep = QtGui.QAction(MainWindow_MemoryView)
        self.actionStep.setObjectName("actionStep")
        self.actionStep_Over = QtGui.QAction(MainWindow_MemoryView)
        self.actionStep_Over.setObjectName("actionStep_Over")
        self.actionExecute_Till_Return = QtGui.QAction(MainWindow_MemoryView)
        self.actionExecute_Till_Return.setObjectName("actionExecute_Till_Return")
        self.actionToggle_Breakpoint = QtGui.QAction(MainWindow_MemoryView)
        self.actionToggle_Breakpoint.setObjectName("actionToggle_Breakpoint")
        self.actionBreakpoints = QtGui.QAction(MainWindow_MemoryView)
        self.actionBreakpoints.setObjectName("actionBreakpoints")
        self.actionFunctions = QtGui.QAction(MainWindow_MemoryView)
        self.actionFunctions.setObjectName("actionFunctions")
        self.actionSet_Address = QtGui.QAction(MainWindow_MemoryView)
        self.actionSet_Address.setObjectName("actionSet_Address")
        self.actionCall_Function = QtGui.QAction(MainWindow_MemoryView)
        self.actionCall_Function.setObjectName("actionCall_Function")
        self.actionLoad_Trace = QtGui.QAction(MainWindow_MemoryView)
        self.actionLoad_Trace.setObjectName("actionLoad_Trace")
        self.actionlibpince = QtGui.QAction(MainWindow_MemoryView)
        self.actionlibpince.setObjectName("actionlibpince")
        self.actionGDB_Log_File = QtGui.QAction(MainWindow_MemoryView)
        self.actionGDB_Log_File.setObjectName("actionGDB_Log_File")
        self.actionSearch_Opcode = QtGui.QAction(MainWindow_MemoryView)
        self.actionSearch_Opcode.setObjectName("actionSearch_Opcode")
        self.actionMemory_Regions = QtGui.QAction(MainWindow_MemoryView)
        self.actionMemory_Regions.setObjectName("actionMemory_Regions")
        self.actionDissect_Code = QtGui.QAction(MainWindow_MemoryView)
        self.actionDissect_Code.setObjectName("actionDissect_Code")
        self.actionReferenced_Strings = QtGui.QAction(MainWindow_MemoryView)
        self.actionReferenced_Strings.setObjectName("actionReferenced_Strings")
        self.actionReferenced_Calls = QtGui.QAction(MainWindow_MemoryView)
        self.actionReferenced_Calls.setObjectName("actionReferenced_Calls")
        self.actionToggle_Attach = QtGui.QAction(MainWindow_MemoryView)
        self.actionToggle_Attach.setObjectName("actionToggle_Attach")
        self.actionRestore_Instructions = QtGui.QAction(MainWindow_MemoryView)

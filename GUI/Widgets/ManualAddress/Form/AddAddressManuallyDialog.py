# Form implementation generated from reading ui file 'GUI/Widgets/ManualAddress/Form/AddAddressManuallyDialog.ui'
#
...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.label_Endianness = QtWidgets.QLabel(parent=Dialog)
        self.label_Endianness.setObjectName("label_Endianness")
        self.horizontalLayout_6.addWidget(self.label_Endianness)
        ...
        self.label_StartBit = QtWidgets.QLabel(parent=self.widget_Length)
        self.label_StartBit.setObjectName("label_StartBit")
        self.horizontalLayout_Length.addWidget(self.label_StartBit)
        self.spinBox_StartBit = QtWidgets.QSpinBox(parent=self.widget_Length)
        self.spinBox_StartBit.setMaximum(7)
        self.spinBox_StartBit.setObjectName("spinBox_StartBit")
        self.horizontalLayout_Length.addWidget(self.spinBox_StartBit)
    ...
    def retranslateUi(self, Dialog):
        ...
        self.label_Endianness.setText(_translate("Dialog", "Endianness:"))

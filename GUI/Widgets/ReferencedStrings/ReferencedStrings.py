...
from GUI.Widgets.ReferencedStrings.Form.ReferencedStringsWidget import Ui_Form
...
class ReferencedStringsWidget(QWidget, Ui_Form):
    ...
    def tableWidget_References_item_double_clicked(self, index: QTableWidgetItem) -> None:
        ...
        self.parent().hex_dump_address(utils.safe_str_to_int(address, 16))

...
"target = address(\"0x0\")  # <- Make sure to change this!\n"
"\n"
"[ENABLE]\n"
"cave = alloc_cave(0x400, \"engine_code_cave\", near=target)\n"
"if not cave:\n"
"    raise RuntimeError(\"Could not allocate a code cave close enough for a relative jump\")\n"
...
"[ENABLE]\n"
"addr = aobscan_first(\"48 8B ?? ?? ?? 89\")  # <- Make sure to change this!\n"
"if addr is None:\n"
...
"[ENABLE]\n"
"expected = \"83 00 FF 48 8B 43 10\"  # <- Make sure to change this!\n"
...
"addr = address(\"0x0\")  # <- Make sure to change this!\n"

...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.gridLayout_2 = QtWidgets.QGridLayout(self.page_General)
        ...
        self.checkBox_AutoUpdateAddressTable = QtWidgets.QCheckBox(parent=self.page_General)
        ...
        self.checkBox_CheckUpdatesOnStartup = QtWidgets.QCheckBox(parent=self.page_General)
        self.checkBox_CheckUpdatesOnStartup.setObjectName("checkBox_CheckUpdatesOnStartup")
        self.verticalLayout_2.addWidget(self.checkBox_CheckUpdatesOnStartup)
        self.verticalLayout_3.addLayout(self.verticalLayout_2)
        self.QWidget_UpdateInterval = QtWidgets.QWidget(parent=self.page_General)
        ...
        self.LockInterval = QtWidgets.QWidget(parent=self.page_General)
        ...
        self.label_8 = QtWidgets.QLabel(parent=self.page_General)
        self.label_8.setObjectName("label_8")
        self.horizontalLayout_3.addWidget(self.label_8)
        self.checkBox_OutputModeAsync = QtWidgets.QCheckBox(parent=self.page_General)
        ...
        self.checkBox_OutputModeCommand = QtWidgets.QCheckBox(parent=self.page_General)
        ...
        self.checkBox_OutputModeCommandInfo = QtWidgets.QCheckBox(parent=self.page_General)
        ...
        self.label_9 = QtWidgets.QLabel(parent=self.page_General)
        self.label_9.setObjectName("label_9")
        self.horizontalLayout_12.addWidget(self.label_9)
        self.lineEdit_AutoAttach = QtWidgets.QLineEdit(parent=self.page_General)
        self.lineEdit_AutoAttach.setObjectName("lineEdit_AutoAttach")
        self.horizontalLayout_12.addWidget(self.lineEdit_AutoAttach)
        self.checkBox_AutoAttachRegex = QtWidgets.QCheckBox(parent=self.page_General)
        ...
        self.label_13 = QtWidgets.QLabel(parent=self.page_General)
        self.label_13.setObjectName("label_13")
        self.horizontalLayout_13.addWidget(self.label_13)
        self.comboBox_Language = QtWidgets.QComboBox(parent=self.page_General)
        ...
        self.label_11 = QtWidgets.QLabel(parent=self.page_General)
        self.label_11.setObjectName("label_11")
        self.horizontalLayout_15.addWidget(self.label_11)
        self.comboBox_Logo = QtWidgets.QComboBox(parent=self.page_General)
        ...
        self.label_14 = QtWidgets.QLabel(parent=self.page_General)
        self.label_14.setObjectName("label_14")
        self.horizontalLayout_17.addWidget(self.label_14)
        self.comboBox_Theme = QtWidgets.QComboBox(parent=self.page_General)
        ...
        self.label_5 = QtWidgets.QLabel(parent=self.page_General)
        self.label_5.setObjectName("label_5")
        self.horizontalLayout_23.addWidget(self.label_5)
        self.comboBox_SaveSessionOnExit = QtWidgets.QComboBox(parent=self.page_General)
        self.comboBox_SaveSessionOnExit.setObjectName("comboBox_SaveSessionOnExit")
        self.horizontalLayout_23.addWidget(self.comboBox_SaveSessionOnExit)
        ...
        self.checkBox_RememberLastPctDirectory = QtWidgets.QCheckBox(parent=self.page_General)
        self.checkBox_RememberLastPctDirectory.setObjectName("checkBox_RememberLastPctDirectory")
        self.verticalLayout_5.addWidget(self.checkBox_RememberLastPctDirectory)
        ...
        self.page_Hotkeys = QtWidgets.QWidget()
        self.page_Hotkeys.setObjectName("page_Hotkeys")
        self.gridLayout_3 = QtWidgets.QGridLayout(self.page_Hotkeys)
        self.gridLayout_3.setObjectName("gridLayout_3")
        self.horizontalLayout_5 = QtWidgets.QHBoxLayout()
        self.horizontalLayout_5.setObjectName("horizontalLayout_5")
        self.verticalLayout_4 = QtWidgets.QVBoxLayout()
        self.verticalLayout_4.setObjectName("verticalLayout_4")
        self.label_3 = QtWidgets.QLabel(parent=self.page_Hotkeys)
        self.label_3.setObjectName("label_3")
        self.verticalLayout_4.addWidget(self.label_3)
        self.listWidget_Functions = QtWidgets.QListWidget(parent=self.page_Hotkeys)
        ...
        self.label_4 = QtWidgets.QLabel(parent=self.page_Hotkeys)
        self.label_4.setObjectName("label_4")
        self.verticalLayout_Hotkey.addWidget(self.label_4)
        self.lineEdit_Hotkey = QtWidgets.QLineEdit(parent=self.page_Hotkeys)
        ...
        self.pushButton_ClearHotkey = QtWidgets.QPushButton(parent=self.page_Hotkeys)
        ...
        self.stackedWidget.addWidget(self.page_Hotkeys)
        self.page_MemoryView = QtWidgets.QWidget()
        self.page_MemoryView.setObjectName("page_MemoryView")
        self.gridLayout_5 = QtWidgets.QGridLayout(self.page_MemoryView)
        self.gridLayout_5.setObjectName("gridLayout_5")
        self.verticalLayout_10 = QtWidgets.QVBoxLayout()
        self.verticalLayout_10.setObjectName("verticalLayout_10")
        self.checkBox_ShowMemoryViewOnStop = QtWidgets.QCheckBox(parent=self.page_MemoryView)
        ...
        self.label_6 = QtWidgets.QLabel(parent=self.page_MemoryView)
        self.label_6.setObjectName("label_6")
        self.horizontalLayout_10.addWidget(self.label_6)
        self.spinBox_InstructionsPerScroll = QtWidgets.QSpinBox(parent=self.page_MemoryView)
        ...
        self.label_16 = QtWidgets.QLabel(parent=self.page_MemoryView)
        self.label_16.setObjectName("label_16")
        self.horizontalLayout_19.addWidget(self.label_16)
        self.spinBox_BytesPerScroll = QtWidgets.QSpinBox(parent=self.page_MemoryView)
        ...
        self.stackedWidget.addWidget(self.page_MemoryView)
        self.page_Debug = QtWidgets.QWidget()
        self.page_Debug.setObjectName("page_Debug")
        self.gridLayout_6 = QtWidgets.QGridLayout(self.page_Debug)
        ...
        self.label_GDBPath = QtWidgets.QLabel(parent=self.page_Debug)
        self.label_GDBPath.setObjectName("label_GDBPath")
        self.horizontalLayout_101.addWidget(self.label_GDBPath)
        self.lineEdit_GDBPath = QtWidgets.QLineEdit(parent=self.page_Debug)
        ...
        self.pushButton_GDBPath = QtWidgets.QPushButton(parent=self.page_Debug)
        ...
        self.checkBox_GDBLogging = QtWidgets.QCheckBox(parent=self.page_Debug)
        ...
        self.label_15 = QtWidgets.QLabel(parent=self.page_Debug)
        self.label_15.setObjectName("label_15")
        self.horizontalLayout_18.addWidget(self.label_15)
        self.comboBox_InterruptSignal = QtWidgets.QComboBox(parent=self.page_Debug)
        ...
        self.pushButton_HandleSignals = QtWidgets.QPushButton(parent=self.page_Debug)
        ...
        self.page_Java = QtWidgets.QWidget()
        self.page_Java.setObjectName("page_Java")
        self.gridLayout_7 = QtWidgets.QGridLayout(self.page_Java)
        self.gridLayout_7.setObjectName("gridLayout_7")
        self.checkBox_JavaSegfault = QtWidgets.QCheckBox(parent=self.page_Java)
        ...
        self.stackedWidget.addWidget(self.page_Java)
    ...
    def retranslateUi(self, Dialog):
        ...
        self.checkBox_CheckUpdatesOnStartup.setText(_translate("Dialog", "Check for AppImage updates on startup"))
...
"Patterns at former positions have higher priority if regex is off"))
        ...
        self.checkBox_RememberLastPctDirectory.setText(_translate("Dialog", "Remember last file save/open across restarts"))

...
#
# Created: Fri Dec  2 21:30:58 2016
...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.lineEdit_AddressInfo = QtWidgets.QLineEdit(Form)
        self.lineEdit_AddressInfo.setReadOnly(True)
        self.lineEdit_AddressInfo.setObjectName("lineEdit_AddressInfo")
        self.verticalLayout.addWidget(self.lineEdit_AddressInfo)
        ...
        self.verticalLayout.addWidget(self.tableWidget_SymbolInfo)

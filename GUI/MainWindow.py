...
class Ui_MainWindow(object):
    ...
    def Speedhack(self, value: int):

        pipe_path = os.path.expanduser("~/.config/speedhack_pipe")
        try:
            self.SpeedHackSlider.setValue(int(self.SpeedHackInput.text()))
            self.SpeedHackInput.setText(str(value))
        except:
            self.SpeedHackInput.setText(str("1"))

        try:
            fd = os.open(pipe_path, os.O_WRONLY | os.O_NONBLOCK)
            with os.fdopen(fd, "w") as f:
                f.write(f"{value}\n")
            self.SpeedHackSlider.setEnabled(True)
            self.SpeedHackInput.setEnabled(True)
            self.SpeedHackStatus.setVisible(False)
            self.SpeedHackRefresh.setVisible(False)
        except:

            self.SpeedHackSlider.setEnabled(False)
            self.SpeedHackInput.setEnabled(False)
            self.SpeedHackStatus.setVisible(True)
            self.SpeedHackRefresh.setVisible(True)
            self.SpeedHackInput.setText(str("1"))
    ...
    def setupUi(self, MainWindow):
        ...
        self.pushButton_AttachProcess.setEnabled(True)
        ...
        self.pushButton_AttachProcess.clicked.connect(self.Speedhack)
        ...
        self.verticalLayout_3.setContentsMargins(-1, 0, -1, 200)
        self.verticalLayout_3.setObjectName("verticalLayout_3")
        self.SpeedHackLabel = QtWidgets.QLabel(parent=self.widget_2)
        self.SpeedHackLabel.setObjectName("SpeedHackLabel")
        self.verticalLayout_3.addWidget(self.SpeedHackLabel)
        self.SpeedHackInput = QtWidgets.QLineEdit(parent=self.widget_2)
        self.SpeedHackInput.setObjectName("SpeedHackInput")
        self.SpeedHackInput.textChanged.connect(self.Speedhack)
        self.verticalLayout_3.addWidget(self.SpeedHackInput)
        self.SpeedHackSlider = QtWidgets.QSlider(parent=self.widget_2)
        self.SpeedHackSlider.setSizeIncrement(QtCore.QSize(0, 0))


        font = QtGui.QFont()
        font.setFamily("Noto Sans")
        self.SpeedHackSlider.setFont(font)
        self.SpeedHackSlider.setMouseTracking(True)
        self.SpeedHackSlider.setAutoFillBackground(False)
        self.SpeedHackSlider.setMinimum(1)
        self.SpeedHackSlider.setMaximum(10)
        self.SpeedHackSlider.setSingleStep(1)
        self.SpeedHackSlider.setOrientation(QtCore.Qt.Orientation.Horizontal)
        self.SpeedHackSlider.setProperty("test", 0)
        self.SpeedHackSlider.setObjectName("SpeedHackSlider")
        self.SpeedHackSlider.valueChanged.connect(self.Speedhack)
        self.verticalLayout_3.addWidget(self.SpeedHackSlider)
        ...
        self.SpeedHackStatus = QtWidgets.QLabel(parent=self.widget_2)
        self.SpeedHackStatus.setText("Speedhack unavailable.\n For this to work you\n need to start your\n process with 'speedhack'\n executable.")
        self.SpeedHackStatus.setStyleSheet("color: red;")
        self.SpeedHackStatus.setVisible(False)
        self.verticalLayout_3.addWidget(self.SpeedHackStatus)
        self.SpeedHackRefresh = QtWidgets.QPushButton(parent=self.widget_2)
        self.SpeedHackRefresh.setText("Refresh")
        self.SpeedHackRefresh.setVisible(False)
        self.SpeedHackRefresh.clicked.connect(self.Speedhack)
        self.verticalLayout_3.addWidget(self.SpeedHackRefresh)

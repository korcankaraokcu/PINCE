...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.widget_3 = QtWidgets.QWidget(parent=self.widget_Scan)
        ...
        self.radioButton_Bits = QtWidgets.QRadioButton(parent=self.widget_3)
        self.radioButton_Bits.setObjectName("radioButton_Bits")
        self.verticalLayout_2.addWidget(self.radioButton_Bits)
        self.radioButton_Decimal = QtWidgets.QRadioButton(parent=self.widget_3)
        ...
        self.checkBox_Hex = QtWidgets.QCheckBox(parent=self.widget_3)

...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.checkBox_IgnoreCase = QtWidgets.QCheckBox(self.widget)
        ...
        self.checkBox_Regex = QtWidgets.QCheckBox(self.widget)
        ...
        self.tableWidget_References = QtWidgets.QTableWidget(self.widget)

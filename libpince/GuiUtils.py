...
#:tag:ValueType
def valuetype_to_text(value_index=int, length=0, zero_terminate=True, value_repr=type_defs.VALUE_REPR.UNSIGNED):
    ...
    Args:
        ...
        value_repr (int): Determines how the data is represented. Can be a member of type_defs.VALUE_REPR
    ...
    if type_defs.VALUE_INDEX.is_integer(value_index):
        if value_repr is type_defs.VALUE_REPR.SIGNED:
            returned_string += "(s)"
        elif value_repr is type_defs.VALUE_REPR.HEX:
            returned_string += "(h)"
...
def text_to_valuetype(string):
    ...
    Returns:
        ...
        value_index, length, zero_terminate, byte_length, value_repr
    ...
    Examples:
        ...
        string="Float64"-->value_index=type_defs.VALUE_INDEX.INDEX_FLOAT64, length=-1, None, 8
    """
    index, length, value_repr = -1, -1, type_defs.VALUE_REPR.UNSIGNED
    zero_terminate = None
    ...
    return index, length, zero_terminate, byte_len, value_repr

...
#:tag:ValueType
def valuetype_to_text(value_index=int, length=0, zero_terminate=True, hex_repr=False):
    ...
    Args:
        ...
        hex_repr (bool): If text should be represented as a hexadecimal value
    ...
    if hex_repr and not type_defs.VALUE_INDEX.has_length(value_index):
        returned_string += "(h)"
...
def text_to_valuetype(string):
    ...
    Returns:
        ...
        value_index, length, zero_terminate, byte_length, hex_repr
    ...
    if type_defs.VALUE_INDEX.has_length(index):
        ...
        hex_repr = True
    return index, length, zero_terminate, byte_len, hex_repr

...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.pushButton_FirstScan = QtWidgets.QPushButton(self.centralwidget)
        self.pushButton_FirstScan.setObjectName("pushButton_FirstScan")
        self.horizontalLayout_6.addWidget(self.pushButton_FirstScan)
        self.pushButton_NextScan = QtWidgets.QPushButton(self.centralwidget)
        ...
        self.pushButton_UndoScan = QtWidgets.QPushButton(self.centralwidget)
        ...
        self.lineEdit_Scan = QtWidgets.QLineEdit(self.centralwidget)
        ...
        self.comboBox_ScanType = QtWidgets.QComboBox(self.centralwidget)
        ...
        self.comboBox_ValueType = QtWidgets.QComboBox(self.centralwidget)
        ...
        self.checkBox_ShowMaps = QtWidgets.QCheckBox(self.centralwidget)
        self.checkBox_ShowMaps.setObjectName("checkBox_ShowMaps")
        self.horizontalLayout_3.addWidget(self.checkBox_ShowMaps)
        self.verticalLayout_3 = QtWidgets.QVBoxLayout()
        self.verticalLayout_3.setObjectName("verticalLayout_3")
        self.checkBox_SimpleValuesOnly = QtWidgets.QCheckBox(self.centralwidget)
        self.checkBox_SimpleValuesOnly.setObjectName("checkBox_SimpleValuesOnly")
        self.verticalLayout_3.addWidget(self.checkBox_SimpleValuesOnly)
        self.checkBox_Unrandomizer = QtWidgets.QCheckBox(self.centralwidget)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.pushButton_FirstScan.setText(_translate("MainWindow", "First Scan"))
        ...
        self.checkBox_ShowMaps.setText(_translate("MainWindow", "Show Maps"))
        self.checkBox_SimpleValuesOnly.setText(_translate("MainWindow", "Simple Values Only"))
        ...
        self.pushButton_CopyToAddressList.setText(_translate("MainWindow", "Copy to Address List"))
        self.pushButton_CleanAddressList.setText(_translate("MainWindow", "Clean Address List"))

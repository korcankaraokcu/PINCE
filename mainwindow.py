...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.pushButton_FirstScan = QtWidgets.QPushButton(self.QWidget_Toolbox)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.comboBox_ValueType.setItemText(0, _translate("MainWindow", "Binary"))
        self.comboBox_ValueType.setItemText(1, _translate("MainWindow", "Byte"))
        self.comboBox_ValueType.setItemText(2, _translate("MainWindow", "2 Bytes"))
        self.comboBox_ValueType.setItemText(3, _translate("MainWindow", "4 Bytes"))
        self.comboBox_ValueType.setItemText(4, _translate("MainWindow", "8 Bytes"))
        self.comboBox_ValueType.setItemText(5, _translate("MainWindow", "Float"))
        self.comboBox_ValueType.setItemText(6, _translate("MainWindow", "Double"))
        self.comboBox_ValueType.setItemText(7, _translate("MainWindow", "String"))
        self.comboBox_ValueType.setItemText(8, _translate("MainWindow", "Array of byte"))
        self.comboBox_ValueType.setItemText(9, _translate("MainWindow", "All"))
